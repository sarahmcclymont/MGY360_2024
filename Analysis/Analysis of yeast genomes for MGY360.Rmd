...
Output: Individual FASTQC reports. Share with class.
Output: MultiQC report summary. Transfer multiQC report off of cluster. Look at plots in the HTML. 
...
Output: BAM and BAI files for each library. BAM files are sorted and duplicates have been flagged. BAIs are indices for visualization later. Figure out a way to upload these so everyone has access to their tracks for looking at their variants.
